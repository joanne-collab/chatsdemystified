...
The notes draw on [*Your Chats, Demystified!*](https://chatsdemystified.bigwaves.ca), a plain-language explainer by Joanne Kerrigan covering how large language models are built, how they work, and why they fail the way they do, which she wrote to support teams' conversations and plans about how, or if, to work with these tools.
